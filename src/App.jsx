...
// === ระบบบีบอัดรูปภาพให้เล็กลงกว่าเดิม (ป้องกันขนาดเกิน 1MB) ===
export const compressImage = (file, callback) => {
  ...
  reader.onload = (event) => {
    ...
    img.onload = () => {
      ...
      const MAX_WIDTH = 600; // ลดความกว้างลงจาก 800 เหลือ 600
      let width = img.width;
      ...
      callback(canvas.toDataURL('image/jpeg', 0.5)); // ปรับ Quality เป็น 0.5
    };
  };
};
...
export default function App() {
  ...
  // === ย้ายสถานะการโหลดมาไว้ระดับสูงสุด (Top Level) ป้องกันบัคจอขาว ===
